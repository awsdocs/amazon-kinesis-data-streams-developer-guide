# Security Best Practices for Kinesis Data Streams<a name="security-best-practices"></a>
...
For more information, see [Logging Amazon Kinesis Data Streams API Calls with AWS CloudTrail](logging-using-cloudtrail.md)\.