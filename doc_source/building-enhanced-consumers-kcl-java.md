# Developing a Consumer with Enhanced Fan\-Out Using the Kinesis Client Library 2\.x in Java<a name="building-enhanced-consumers-kcl-java"></a>

You can use version 2\.0 or later of the Kinesis Client Library \(KCL\) to develop applications in Amazon Kinesis Data Streams that use enhanced fan\-out to receive data from streams\. 

The following code shows an example implementation in Java of `ProcessorFactory` and `RecordProcessor`\.
