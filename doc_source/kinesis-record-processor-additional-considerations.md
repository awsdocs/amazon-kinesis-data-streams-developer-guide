...
Here are some additional considerations to incorporate into the design of your Amazon Kinesis Streams application\.


+ [Starting Up Data Producers and Data Consumers](#kinesis-record-processor-producer-consumer-coordination)
+ [Shutting Down an Amazon Kinesis Streams Application](#developing-consumers-with-kcl-shutdown)
...
## Shutting Down an Amazon Kinesis Streams Application<a name="developing-consumers-with-kcl-shutdown"></a>
