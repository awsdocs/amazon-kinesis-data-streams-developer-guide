...
| Update KPL content for release 0\.10\.0\. | Added [Developing Amazon Kinesis Data Streams Producers Using the Kinesis Producer Library](developing-producers-with-kpl.md)\. | July 15, 2015 | 
...
| New KPL developer's guide topic\. | Added [Developing Amazon Kinesis Data Streams Producers Using the Kinesis Producer Library](developing-producers-with-kpl.md)\. | June 02, 2015 | 
...
| Default shard limit | Updated the [Amazon Kinesis Data Streams Limits](service-sizes-and-limits.md): the default shard limit has been raised from 5 to 10\. | February 25, 2014 | 
| Default shard limit | Updated the [Amazon Kinesis Data Streams Limits](service-sizes-and-limits.md): the default shard limit has been raised from 2 to 5\. | January 28, 2014 | 
